...
- `GET /api/github/repos` — always `AgentBasis/agentbasis-python-sdk`
...
`GITHUB_TOKEN` is required for Product. The scan is pinned to
`AgentBasis/agentbasis-python-sdk` — Product observes only, it does not ship.
